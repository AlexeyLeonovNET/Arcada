...
namespace Asteroids
{
    ...
    {
        public static GameObject SetName(this GameObject gameObject, string
        name)
        {
...
public static GameObject AddBoxCollider2D(this GameObject gameObject)
        ...
        public static GameObject AddSprite(this GameObject gameObject, Sprite
        sprite)
        {
        ...
        private static T GetOrAddComponent<T>(this GameObject gameObject) where
        T : Component
        {
